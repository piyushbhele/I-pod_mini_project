...
class App extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      songItems: ["Besomorph  Silent Child  IDGAF", "Billie Eilish  Six Feet Under", "Confetti  Ghost",
        "DHARIA  Sugar  Brownies", "Jony Love Your Voice"], //song names
  ...
  changeMenuForward = (id, fromMenu) => {
    const { navigationStack, currentMenu, menuMapping } = this.state;
  ...
  render() {
    const { audio, active, currentMenu, menuItems, musicItems, songItems,
      playing, songIndex, theme, songUrl, songImgUrl, wheelColor, wallpaper,
      wallpaperItems, noty, notifyText } = this.state
      ...
      <div className="case-container">
        <div style={{ backgroundColor: theme }} className="case">
          ...
          <Wheel
            ...
            onChangeMenuForward={this.changeMenuForward}
            updateActiveMenu={this.updateActiveMenu}
            onChangeMenuBackward={this.changeMenuBackward}
